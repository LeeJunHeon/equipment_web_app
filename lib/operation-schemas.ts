...
export const OPERATION_SCHEMAS: OperationSchema[] = [
  {
    ...
    fields: [
      ...
      { name: "occurredAt",    label: "발생일",     type: "date",   required: false, auto: "today" },
    ],
    steps: [
    ...
    cardShow: ["equipmentId", "symptom", "description", "status", "replacedParts", "isExternal", "vendorName"],
  },
  {
    id: "equipment_vent",
    label: "벤트 등록",
    ...
    cardTitle: "벤트 등록 확인",
    cardShow: ["equipmentId", "ventReason", "description"],
  },
  {
    ...
    cardTitle: "클리닝 등록 확인",
    cardShow: ["equipmentId", "cleaningType", "nextScheduledAt", "description"],
  },
];
